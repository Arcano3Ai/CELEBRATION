...
export const CELEBRATION_FAQ_DB = [
  {
    ...
    response: "CELEBRATION ofrece tres colecciones oficiales de alta costura digital con entregables tangibles:\n\n1. **Colección Signature ($7,900 MXN):** Sitio web editorial a medida, dominio propio (.com / .wedding) con SSL por 1 año, Smart RSVP predictivo por familia con control estricto de pases y alergias, itinerario con GPS Waze/Maps, mesa de regalos dual (CLABE de 1-clic + tiendas departamentales) y pases digitales personalizados para WhatsApp.\n\n2. **Colección Destination & Heritage ($11,900 MXN - Más Solicitada):** Todo lo de Signature más arquitectura Multi-Evento con RSVP segmentado (rompehielos, ceremonia, tornaboda/brunch), bilingüe nativo (Español/Inglés), módulo concierge de convenios hoteleros, transporte y recomendaciones locales curadas, y libro de firmas digital conmemorativo.\n\n3. **Colección Grand Luxe NFC & Live Event ($14,900 MXN - Experiencia Suprema):** Todo lo de Destination más hardware físico de tarjetas inteligentes NFC (1 Maestra en acrílico/madera noble para los novios + 15 a 20 tarjetas grabadas para centros de mesa), pantalla interactiva Live Event para proyectar fotos de los invitados en directo durante la fiesta sin instalar apps, entrega de archivo RAW y guardia técnica VIP durante el enlace.\n\n*También contamos con **Atelier Bespoke** para bodas monumentales de más de 350 invitados o festivales de varios días con cotización personalizada.*"
  },
  {
    topic: "tiempos",
