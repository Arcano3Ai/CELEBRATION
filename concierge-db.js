...
export const CELEBRATION_FAQ_DB = [
  {
    topic: "paquetes",
    keywords: ["paquete", "precio", "cuanto cuesta", "costo", "tarifa", "precios", "coleccion"],
    response: "CELEBRATION ofrece 3 colecciones exclusivas para esta temporada:\n\n1. **Signature Web ($1,890 MXN):** Sitio web completo, dominio propio por 1 año, Smart RSVP, cuenta regresiva, itinerario con GPS, mesa de regalos y galería sin límites.\n2. **Deluxe Suite ($2,790 MXN):** Todo lo anterior más multi-evento (rompehielos, tornaboda), música selecta, hospedaje con códigos convenio y versión bilingüe.\n3. **Grand Luxe NFC & Live Event ($4,490 MXN):** Incluye 15 tarjetas inteligentes de proximidad NFC para mesas y la galería Live Event donde los invitados proyectan fotos en vivo durante la fiesta."
  },
  {
    topic: "tiempos",
